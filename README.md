...
> **SQLite** is bundled with PHP by default — no separate database server is required.
...
This uses `concurrently` to launch all four processes in parallel:
...
This project uses **[Pest](https://pestphp.com)** — a testing framework with a clean, expressive syntax built on top of PHPUnit.
